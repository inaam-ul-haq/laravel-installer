...
namespace Inaam\Installer\Providers;

use Illuminate\Routing\Router;
use Illuminate\Support\ServiceProvider;
use Inaam\Installer\Middleware\ApplicationStatus;
use Inaam\Installer\Repositories\ApplicationStatusRepository;
use Inaam\Installer\Middleware\canInstall;
use Inaam\Installer\Middleware\canUpdate;
